      ...
      <div className="relative overflow-hidden group">
        ...
        <div className="flex marquee-animation group-hover:animation-paused">
          {[...companies, ...companies].map((company, i) => (
            <span
              key={`${company}-${i}`}
              className="flex-shrink-0 px-8 font-display font-semibold text-neutral-300 text-lg tracking-tight hover:text-neutral-500 transition-colors cursor-default select-none"
            >
              {company}
            </span>
          ))}
