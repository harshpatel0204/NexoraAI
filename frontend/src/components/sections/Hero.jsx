...
function DashboardMockup() {
  return (
    <motion.div
      ...
      className="bg-white rounded-xl3 shadow-card-lg border border-neutral-200 overflow-hidden"
    >
      {/* Browser chrome */}
      <div className="flex items-center gap-3 px-4 py-3 border-b border-neutral-100 bg-neutral-50">
        ...
        <div className="flex-1 text-center">
          <span className="text-xs text-neutral-400 bg-white px-4 py-1 rounded-md border border-neutral-200 font-mono">
      ...
      <div className="p-5">
        ...
        <div className="grid grid-cols-3 gap-3 mb-5">
          {[
            ...
            <div key={stat.label} className="bg-white border border-neutral-200 rounded-lg p-3 text-center">
        ...
        <div className="bg-neutral-50 rounded-lg border border-neutral-100 p-4 space-y-3">
          ...
          <div className="flex justify-start">
            <div className="bg-white border border-neutral-200 text-neutral-700 text-xs px-3 py-2 rounded-lg rounded-bl-sm max-w-[75%]">
          ...
          {/* Typing indicator */}
          <div className="flex justify-start">
            <div className="bg-white border border-neutral-200 px-3 py-2 rounded-lg rounded-bl-sm flex items-center gap-1">
        ...
        <div className="mt-3 flex items-center gap-2">
          <div className="flex-1 bg-white border border-neutral-200 rounded-lg px-3 py-2 text-xs text-neutral-400">
...
export default function Hero() {
  return (
    <section className="relative pt-24 pb-16 md:pt-32 md:pb-24 bg-neutral-50 bg-[radial-gradient(ellipse_80%_60%_at_70%_-10%,rgba(43,127,232,0.08),transparent)]">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            <motion.div variants={itemVariants}>
              <span className="inline-flex items-center gap-1.5 bg-brand-50 text-brand-700 border border-brand-200 text-xs font-semibold px-3 py-1.5 rounded-full">
            ...
            <motion.h1
              ...
              className="font-display font-bold text-display-2xl text-neutral-900 tracking-tight mt-6"
            >
            ...
            <motion.p
              variants={itemVariants}
              className="font-body text-lg text-neutral-600 leading-relaxed max-w-lg mt-6"
            >
            ...
            <motion.div variants={itemVariants} className="mt-8 flex flex-wrap gap-3 items-center">
              ...
              <a
                href="#results"
                className="inline-flex items-center gap-1 text-neutral-700 hover:text-brand-600 font-medium text-sm transition-colors"
              >
            ...
            <motion.div variants={itemVariants} className="mt-5 flex items-center gap-3">
              ...
              <span className="text-sm text-neutral-500">
                Join <span className="font-semibold text-neutral-700">120+</span> companies already using AI with us
              </span>
            </motion.div>
          </motion.div>
