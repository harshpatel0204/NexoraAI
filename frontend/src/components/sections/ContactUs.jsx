          ...
          >
            ...
            <div className="bg-white dark:bg-neutral-900 rounded-xl2 border border-neutral-200 dark:border-neutral-700 shadow-card p-5">
              ...
              <div className="flex gap-3">
                ...
                {/* Email */}
                <a href="mailto:hello@nexora.ai" className="w-10 h-10 rounded-lg bg-neutral-100 dark:bg-neutral-800 border border-neutral-200 dark:border-neutral-700 flex items-center justify-center text-neutral-500 hover:text-neutral-800 dark:hover:text-white hover:border-neutral-300 dark:hover:border-neutral-600 transition-all duration-200 hover:-translate-y-0.5" aria-label="Email">
                  <Mail size={16} />
                </a>
              </div>
            </div>
